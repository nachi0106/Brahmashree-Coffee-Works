...
<div class="row form-group">
<div class="col-12">
<div class="form-group"><label for="city" class=" form-control-label">Lecturer Mobile Number</label><input type="tel" name="mobilenumber" id="mobilenumber" value="<?php  echo $row->MobileNumber;?>" class="form-control" required="true" pattern="[0-9]{10}"/></div>
</div>
</div>
...
<div class="row form-group">
<div class="col-12">
<div class="form-group"><label for="city" class=" form-control-label">Lecturer Address</label><input type type="text" name="address" id="address" class="form-control" rows="5" cols="12" required pattern="[a-zA-Z0-9]+"><?php  echo $row->Address;?></textarea></div>
</div>
<div class="col-12">
